...
@section('meta_description', 'Find licensing, permits, taxes, and compliance requirements for your industry. Restaurant,
    Trucking, Real Estate, Cleaning and more.')

@section('meta_keywords', 'business industries, industry requirements, business license by industry, industry permits,
    industry compliance')
        ...
        <div class="relative container mx-auto px-4 py-16">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
                    Find licensing, permits, taxes, and compliance requirements for your industry.
                </p>
            </div>
        </div>

...
@section('page_title', 'National Compliance Calendar')

@section('page_subtitle', 'All 50 States. All Entity Types. One Master Schedule.')
            ...
            <div class="bg-white border border-slate-200 rounded-xl p-6 md:p-8 shadow-xl">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-end">
                        <button type="button"
                            class="w-full bg-slate-900 text-white rounded-lg px-4 py-2.5 text-sm font-bold hover:bg-slate-800 transition"
                            id="applyFilter">
                            Filter
                        </button>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-12">
            ...
            <div class="lg:col-span-4">
                <div class="sticky top-24 bg-white border-2 border-blue-600 rounded-xl p-6 shadow-sm">
                    ...
                    <p class="text-sm text-slate-500 mt-2 leading-relaxed">Stop checking calendars manually. Our 9-step
                        automation syncs with state databases to handle your filings automatically.</p>
                    <ul class="text-sm text-slate-600 mt-4 space-y-2">
                        <li class="flex items-center"><i class="fa-solid fa-check text-green-500 mr-2"></i> Registered Agent
                            Alerts</li>
                        <li class="flex items-center"><i class="fa-solid fa-check text-green-500 mr-2"></i> Auto-Generated
                            Reports</li>
                        <li class="flex items-center"><i class="fa-solid fa-check text-green-500 mr-2"></i> $0 Late Fee
                            Guarantee</li>
                    </ul>
                    <a href="{{ route('formation.start') }}"
                        class="block w-full mt-6 bg-blue-600 text-white text-center font-bold py-2.5 rounded-lg hover:bg-blue-700 transition">Enroll
                        My Business</a>
                </div>
            </div>
        </div>

...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.admin-users.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-lg font-semibold text-gray-900">Admin Users List</h3>
            ...
            <form action="{{ route('admin.admin-users.bulk-action') }}" method="POST" id="bulkForm">
                @csrf
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($admins as $admin)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-500">{{ $admin->login_name }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full
                                            @if ($admin->status) bg-green-100 text-green-800
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        @if ($admin->id !== auth('admin')->id())
                                            <button type="button"
                                                onclick="deleteItem({{ $admin->id }}, '{{ route('admin.admin-users.destroy', $admin) }}')"
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="px-6 py-4 text-center text-gray-500">No admin users found.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>

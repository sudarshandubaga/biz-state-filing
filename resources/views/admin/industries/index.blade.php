...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.industries.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-lg font-semibold text-gray-900">Industries List</h3>
            ...
            <form action="{{ route('admin.industries.bulk-action') }}" method="POST" id="bulkForm">
                @csrf
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($industries as $industry)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <input type="checkbox" name="ids[]" value="{{ $industry->id }}"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-500">{{ $industry->slug ?? 'N/A' }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <button type="button"
                                            onclick="deleteItem({{ $industry->id }}, '{{ route('admin.industries.destroy', $industry) }}')"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">No industries found.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
